...
func SafecastReadGateway(gatewayId string) (isAvail bool, isReset bool, sv SafecastGatewayStatus) {
    ...
    filename := SafecastDirectory() + TTGatewayLogPath + "/" + gatewayId + ".json"
...
func SafecastWriteGateway(ttg TTGateReq) {
    ...
    filename := SafecastDirectory() + TTGatewayLogPath + "/" + ttg.GatewayId + ".json"
