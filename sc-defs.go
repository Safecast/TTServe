...
type Service struct {
	...
	UploadedAtNano *int64	`json:"service_uploaded_nano,omitempty"`
...
type Gateway struct {
	...
	ReceivedAtNano *int64	`json:"gateway_received_nano,omitempty"`
...
type Loc struct {
	...
	MotionBeganNano *int64	`json:"loc_when_motion_began_nano,omitempty"`
...
type SafecastData struct {
    ...
    CapturedAtNano *int64	`json:"when_captured_nano,omitempty"`
	*Loc					`json:",omitempty"`
	*Env					`json:",omitempty"`
	*Bat					`json:",omitempty"`
	*Lnd					`json:",omitempty"`
