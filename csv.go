...
func csvAppend(fd *os.File, sd *SafecastData, first bool) {
    ...
    if sd.Pms != nil && sd.Pms.Std01_0 != nil {
        s += fmt.Sprintf(",%f", *sd.Pms.Std01_0)
    } else {
        s += ","
    }
    ...
    if sd.Pms != nil && sd.Pms.Std02_5 != nil {
        s += fmt.Sprintf(",%f", *sd.Pms.Std02_5)
    } else {
        s += ","
    }
    ...
    if sd.Pms != nil && sd.Pms.Std10_0 != nil {
        s += fmt.Sprintf(",%f", *sd.Pms.Std10_0)
    } else {
        s += ","
    }
    ...
    if sd.Opc != nil && sd.Opc.Std01_0 != nil {
        s += fmt.Sprintf(",%f", *sd.Opc.Std01_0)
    } else {
        s += ","
    }
    ...
    if sd.Opc != nil && sd.Opc.Std02_5 != nil {
        s += fmt.Sprintf(",%f", *sd.Opc.Std02_5)
    } else {
        s += ","
    }
    ...
    if sd.Opc != nil && sd.Opc.Std10_0 != nil {
        s += fmt.Sprintf(",%f", *sd.Opc.Std10_0)
    } else {
        s += ","
    }
    ...
    if sd.Dev != nil && sd.Dev.OvercurrentEvents != nil {
        s += fmt.Sprintf(",%d", *sd.Dev.OvercurrentEvents)
    } else {
        s += ","
    }
