...
// Sorted index of the words
var Index2048 [2048]int

// 2048 words, unsorted.  If one seems offensive, you can replace the word in-place but you can't
// in any way resort the array.
