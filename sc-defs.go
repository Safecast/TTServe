...
type Service struct {
	...
	UploadedAtNano *string	`json:"service_uploaded_nano,omitempty"`
...
type Gateway struct {
	...
	ReceivedAtNano *string	`json:"gateway_received_nano,omitempty"`
...
type Loc struct {
	...
	MotionBeganNano *string	`json:"loc_when_motion_began_nano,omitempty"`
...
type SafecastData struct {
    ...
    CapturedAtNano *string	`json:"when_captured_nano,omitempty"`
	*Loc					`json:",omitempty"`
	*Env					`json:",omitempty"`
	*Bat					`json:",omitempty"`
	*Lnd					`json:",omitempty"`
