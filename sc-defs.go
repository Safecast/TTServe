...
type SafecastData struct {
	...
	DeviceContact *note.EventContact `json:"device_contact,omitempty"`

	// Optional accountability information for the event
	Source *note.EventApp `json:"source,omitempty"`
