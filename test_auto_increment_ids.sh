...
DEVICE_ID=55555  # Unique device ID to easily identify our test data
TIMESTAMP=$(date -u +"%Y-%m-%dT%H:%M:%SZ")

echo "=== Testing TTServe Auto-Increment IDs ==="
...
echo "3. Sending test request with device ID $DEVICE_ID..."
...
# Send request to TTServe and capture the response
