...
// Cloned from: https://github.com/TheThingsNetwork/ttn/blob/develop/core/definitions.go
// Found via: https://staging.thethingsnetwork.org/wiki/Backend/Connect/Application
